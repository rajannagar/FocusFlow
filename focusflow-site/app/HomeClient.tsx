    ...
    <div className="min-h-screen bg-[var(--background)]">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20 sm:pt-24 md:pt-0">
        ...
        <div className="absolute inset-0">
          ...
          />
          <div 
            className="absolute bottom-1/3 right-1/4 w-[350px] md:w-[700px] h-[350px] md:[700px] rounded-full blur-[80px] md:blur-[120px] opacity-[0.06] transition-transform duration-[3000ms] ease-out"
            style={{
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="text-center lg:text-left space-y-8 md:space-y-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-4">
                  ...
                  <Link 
                    href="/features"
                    className="px-6 py-3.5 sm:px-8 sm:py-4 rounded-2xl border-2 border-[var(--border)] text-[var(--foreground)] font-semibold text-base sm:text-lg hover:border-[var(--accent-primary)]/50 hover:bg-[var(--background-elevated)] transition-all duration-300 touch-manipulation"
                    style={{ minHeight: '44px' }}
                  >
                    Explore Features
                  </Link>
      ...
      <section 
        ...
        className="relative py-12 sm:py-16 md:py-24 overflow-hidden opacity-0 transition-opacity duration-1000"
      >
            ...
            <div className="grid md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
              {[
                ...
                return (
                  <div 
                    key={i}
                    className="group relative p-6 sm:p-8 md:p-10 rounded-3xl bg-[var(--background-elevated)] border border-[var(--border)] hover:border-[var(--accent-primary)]/30 transition-all duration-500 hover:shadow-xl hover:shadow-[var(--accent-primary)]/10"
                  >
      ...
      <section 
        ...
        className="relative py-12 sm:py-16 md:py-24 bg-[var(--background-elevated)] overflow-hidden opacity-0 transition-opacity duration-1000"
      >
        {/* Section divider */}
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[var(--border)] to-transparent" />
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              ...
              <div className="space-y-6 md:space-y-8">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <Link 
                    href="/webapp"
                    className="px-6 py-3.5 sm:px-8 sm:py-4 rounded-2xl bg-gradient-to-r from-[var(--accent-primary)] to-[var(--accent-primary-dark)] text-white font-semibold text-base sm:text-lg hover:scale-[1.02] hover:shadow-2xl hover:shadow-[var(--accent-primary)]/30 transition-all duration-300 text-center touch-manipulation"
                    style={{ minHeight: '44px' }}
                  >
                  ...
                  <Link 
                    href="/features"
                    className="px-6 py-3.5 sm:px-8 sm:py-4 rounded-2xl border-2 border-[var(--border)] text-[var(--foreground)] font-semibold text-base sm:text-lg hover:border-[var(--accent-primary)]/50 hover:bg-[var(--background-elevated)] transition-all duration-300 text-center touch-manipulation"
                    style={{ minHeight: '44px' }}
                  >
                    Learn More
                  </Link>
        ...
        <Container>
          <div className="max-w-4xl mx-auto text-center px-4 md:px-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link 
                href="/pricing"
                className="px-6 py-3.5 sm:px-8 sm:py-4 rounded-2xl bg-gradient-to-r from-[var(--accent-primary)] to-[var(--accent-primary-dark)] text-white font-semibold text-base sm:text-lg hover:scale-[1.02] hover:shadow-2xl hover:shadow-[var(--accent-primary)]/30 transition-all duration-300 touch-manipulation"
                style={{ minHeight: '44px' }}
              >
                View Pricing
              </Link>
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-3.5 sm:px-8 sm:py-4 rounded-2xl border-2 border-[var(--border)] text-[var(--foreground)] font-semibold text-base sm:text-lg hover:border-[var(--accent-primary)]/50 hover:bg-[var(--background)] transition-all duration-300 touch-manipulation"
                style={{ minHeight: '44px' }}
              >
                Download Free
              </a>
        ...
        <Container>
          <div className="max-w-5xl mx-auto text-center px-4 md:px-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative inline-flex items-center gap-3 px-6 py-3.5 sm:px-8 sm:py-4 md:px-10 md:py-5 rounded-2xl bg-gradient-to-r from-[var(--accent-primary)] to-[var(--accent-primary-dark)] text-white font-semibold text-base sm:text-lg md:text-xl overflow-hidden transition-all duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-[var(--accent-primary)]/40 touch-manipulation"
              style={{ minHeight: '44px' }}
            >
              <div className="absolute inset-0 bg-gradient-to-r from-[var(--accent-primary-light)] to-[var(--accent-primary)] opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
