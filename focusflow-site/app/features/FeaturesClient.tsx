      ...
      >
        ...
        <Container>
          <div className="max-w-7xl mx-auto px-4 md:px-6">
            ...
            <div className="grid lg:grid-cols-2 gap-6 sm:gap-10 lg:gap-16 items-center mb-12 sm:mb-16 md:mb-20">
          ...
          <div className="max-w-6xl mx-auto px-4 md:px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              {[
                ...
                return (
                  <div key={i} className="group p-5 sm:p-6 md:p-8 rounded-3xl bg-[var(--background-elevated)] border border-[var(--border)] hover:border-[var(--accent-primary)]/50 transition-all hover:scale-105 hover:shadow-xl">
